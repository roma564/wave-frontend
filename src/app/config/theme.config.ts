...
export const themeConfig: Record<ThemeName, {
  ...
  PURPLE: { bgColor: '#F3E5F5',chatListBgColor: '#172134',chatBgColor:'#172134',chatBgColorSecondary:'#172134', textColor: '#4A148C', secondaryTextColor: '#7B1FA2', primaryColor: '#9C27B0',borderColor:'#2196F3',iconsColor:'#C5C8CE' },
}
