    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          ...
          >
            <h2 className="text-xl font-semibold mb-4">Створити новий режим</h2>
            ...
            {/* Вибір теми */}
            <label className="block mb-2 text-sm font-medium">Тема</label>
           {/* Вибір теми як галерея */}
<label className="block mb-2 text-sm font-medium">Оберіть тему</label>
        ...
        <span className="text-sm font-medium">{theme}</span>
            ...
            <div className="space-y-2 mb-4 text-black">
              ...
              <label>
                ...
                /> Restricted Smile Mode
              </label>
            </div>

            {/* Quick Messages */}
            <label className="block mb-2 text-sm font-medium">Швидкі повідомлення</label>
            <input
              type="text"
